...
const ExternalLinkIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <main className="h-screen flex justify-between px-[5vw] py-[10vh]">
        ...
        <div className="w-full items-right text-white flex flex-col justify-between">
          <div className="text-right space-y-4">
            ...
            <h2 className="text-xl font-avenir">Full Stack Developer / App & Web Designer</h2>
          </div>
