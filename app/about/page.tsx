  ...
  return (
    <main className="h-screen flex justify-between px-[5vw] py-[10vh]">
      <div className="flex flex-col items-start w-full min-h-screen text-white gap-8">
        <h1 className="text-3xl font-futura tracking-wider">Who am I ?</h1>
        <Menu />
      </div>

      <div className="w-full items-right text-white flex flex-col justify-between">
        <div className="text-right space-y-4">
          <h1 className="text-3xl font-futura tracking-wider">Kizuki Aiki</h1>
          <h2 className="text-xl">Full Stack Developer / App &amp; Web Designer</h2>
        </div>

        <div className="text-xl text-right font-light space-y-4">
        ...
        <div className="w-full flex flex-col items-end text-right text-white">
          {socials.map((social) => (
            <a
              ...
              className="flex items-center gap-2 text-white hover:text-gray-300 font-futura tracking-wider"
            >
              {social.name}
              <svg
